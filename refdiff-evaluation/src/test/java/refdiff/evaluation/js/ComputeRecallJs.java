...
public class ComputeRecallJs {
	...
	public static void main(String[] args) throws Exception {
		...
		computeRecall("Move Function",
			...
			commit("https://github.com/facebook/react/commit/8fbcd499bd07c8a8206f23fe0b2a1cbbc1ffaf0a", RelationshipType.MOVE, node("src/renderers/shared/fiber/ReactFiberClassComponent.js", "validateCallback"), node("src/renderers/shared/utils/validateCallback.js", "validateCallback")),
		...
		computeRecall("Rename Function",
			...
			commit("https://github.com/webpack/webpack/commit/86c00207bdc9cb1ef60441d1ec836624a162c9ab", RelationshipType.RENAME, node("lib/ModuleParserHelpers.js", "addParsedVariable"), node("lib/ParserHelpers.js", "addParsedVariableToModule")),
