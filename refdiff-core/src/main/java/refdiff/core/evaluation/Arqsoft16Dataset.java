...
import refdiff.core.utils.RefactoringRelationship;
...
//    orientdb_b213aaf.add(item("Pull Up Method", "com.orientechnologies.orient.client.remote.OengineRemote#NAME", "com.orientechnologies.orient.core.engine.OengineAbstract#NAME")); // errado
    ...
    orientdb_b213aaf.add(item("Pull Up Field", "com.orientechnologies.orient.core.engine.local.OEngineLocalPaginated.NAME", "com.orientechnologies.orient.core.engine.OEngineAbstract#NAME")); // certo
    orientdb_b213aaf.add(item("Pull Up Field", "com.orientechnologies.orient.core.engine.memory.OEngineMemory.NAME", "com.orientechnologies.orient.core.engine.OEngineAbstract#NAME")); // certo
